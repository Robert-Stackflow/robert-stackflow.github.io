      ...
      var s = function() {
          ...
          return a(e, [{
              ...
              value: function() {
                  ...
                  var offset = this.player.lrcMargin + 16;
                  if (this.index > this.current.length - 1 || e < this.current[this.index][0] || !this.current[this.index + 1] || e >= this.current[this.index + 1][0])
                      for (var t = 0; t < this.current.length; t++)
                          ...
                          this.container.style.transform = "translateY(" + offset * -this.index + "px)",
                          this.container.style.webkitTransform = "translateY(" + offset * -this.index + "px)",
                          this.container.getElementsByClassName("aplayer-lrc-current")[0].classList.remove("aplayer-lrc-current"),
                          this.container.getElementsByTagName("p")[t] && this.container.getElementsByTagName("p")[t].classList.add("aplayer-lrc-current"))
              }
          }, {
              key: "switch",
              value: function(e) {
      ...
      var m = []
        , g = function() {
          function e(t) {
              ...
              this.options = (0,
              s.default)(t),
              this.lrcMargin=this.options.lrcMargin?parseInt(this.options.lrcMargin):0,
